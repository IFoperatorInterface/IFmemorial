...
public class EffectController {
  ...
  public void adrBehavior() {
    ...
    controlP5.getController("adrBehaviorTransition1").setPosition(w0 + pos0, PApplet.parseInt(windows[2].pos.y));
    for (int i = 0; i < adrBt.length; i++) {
      controlP5.getController("adrBehaviorTransition" + i).setSize(areaWidth / 2, PApplet.parseInt(windows[2].size.y) - 10);
